	...
	return (
		<>
					...
					<div className="md:w-7/12">
						<form onSubmit={handleSubmit}>
							...
							<div className="flex flex-wrap md:flex-nowrap items-center gap-2">
								<button className="btn-primary">Solve</button>
			...
			<section className="container mx-auto px-6 sm:px-20 2xl:px-16 flex flex-col gap-3 mb-8">
				...
				{!solutionPresent && (
					<p className="solution-text">No Solutions found for given input</p>
				)}
				{isProcessing && <p className="solution-text">Processing...</p>}
			</section>
		</>
	)
}
